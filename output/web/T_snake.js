...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'output/web/T_snake.data';
      var REMOTE_PACKAGE_BASE = 'T_snake.data';
  ...
  Module['FS_createPath']('/', 'assets', true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_output/web/T_snake.data');

      };
      Module['addRunDependency']('datafile_output/web/T_snake.data');
   ...
   loadPackage({"files": [{"filename": "/assets/Terminess_Mono.ttf", "start": 0, "end": 848728, "audio": 0}, {"filename": "/assets/FreeSans.ttf", "start": 848728, "end": 1102508, "audio": 0}], "remote_package_size": 1102508, "package_uuid": "0b7d556f-36d1-4d7f-b015-a5e071a584b6"});
...
var wasmBinaryFile = 'T_snake.wasm';
...
var ASM_CONSTS = {
 ...
 38995: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 39984: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 40077: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 41302: function() {return screen.width;},  
 41329: function() {return screen.height;},  
 41357: function() {return window.innerWidth;},  
 41389: function() {return window.innerHeight;},  
 41467: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 41601: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 41767: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
